...
function Generatorlist() {
  ...
  const handleGeneratePassword = async () => {
    ...
    try {
      const response = await axios.get(
        `https://api-commonfunlib.onrender.com/generate/password?length=${passwordLength}`
      );
  ...
  const handleGenerateRandomName = async () => {
    setNameLoading(true);
    try {
      const response = await axios.get(`https://api-commonfunlib.onrender.com/generate/name`);
  ...
  const handleGenerateRandomNumber = async () => {
    ...
    try {
      const response = await axios.get(
        `https://api-commonfunlib.onrender.com/generate/number?min=${minValue}&max=${maxValue}`
      );
